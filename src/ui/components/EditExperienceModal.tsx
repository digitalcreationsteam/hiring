...
const EditExperienceModal: React.FC<EditExperienceModalProps> = ({
  ...
  const validate = (): boolean => {
    ...
    if (!form.currentlyWorking && !form.endYear) newErrors.endYear = "End year is required";
    setErrors(newErrors);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs mt-0.5" style={{ color: uniTalentColors.secondary }}>
                {experience?._id ? "Update your work history" : "Add a new work entry"}
              </p>
            </div>
          </div>
          <button
            ...
            style={{ backgroundColor: `${uniTalentColors.lightGray}40`, color: uniTalentColors.secondary }}
          >
            <X size={18} />
          </button>
        </div>
          ...
          <div>
            <label className={labelClass} style={{ color: uniTalentColors.text }}>
              <span className="flex items-center gap-2">
                <Briefcase size={14} style={{ color: uniTalentColors.primary }} />
                Job Title <span style={{ color: uniTalentColors.primary }}>*</span>
              </span>
            </label>
            <input
              type="text"
              ...
              style={{
                borderColor: errors.jobTitle ? "#fca5a5" : `${uniTalentColors.lightGray}80`,
                color: uniTalentColors.text,
                outline: `1px solid ${uniTalentColors.primary}`,
              }}
            />
            {errors.jobTitle && (
              <p className="text-xs mt-1.5" style={{ color: "#dc2626" }}>{errors.jobTitle}</p>
            )}
          </div>
          ...
          <div>
            <label className={labelClass} style={{ color: uniTalentColors.text }}>
              <span className="flex items-center gap-2">
                ...
                Company Name <span style={{ color: uniTalentColors.primary }}>*</span>
              </span>
            </label>
            <input
              type="text"
              ...
              className={inputClass}
              style={{
                borderColor: errors.companyName ? "#fca5a5" : `${uniTalentColors.lightGray}80`,
                color: uniTalentColors.text,
              }}
            />
            {errors.companyName && (
              <p className="text-xs mt-1.5" style={{ color: "#dc2626" }}>{errors.companyName}</p>
            )}
          </div>
            ...
            <div className="relative">
              <select
                ...
                style={{
                  ...
                  color: form.typeOfRole ? uniTalentColors.text : uniTalentColors.secondary,
                }}
              >
          ...
          <div>
            <label className={labelClass} style={{ color: uniTalentColors.text }}>
              <span className="flex items-center gap-2">
                ...
                Start Date <span style={{ color: uniTalentColors.primary }}>*</span>
              </span>
            </label>
            <div className="grid grid-cols-2 gap-3">
              <div className="relative">
                <select
                  ...
                  style={{
                    borderColor: `${uniTalentColors.lightGray}80`,
                    color: form.startMonth ? uniTalentColors.text : uniTalentColors.secondary,
                  }}
                >
                ...
                <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: uniTalentColors.secondary }} />
              </div>
              <div className="relative">
                <select
                  name="startYear"
                  ...
                  className={inputClass + " appearance-none pr-8 cursor-pointer"}
                  style={{
                    borderColor: errors.startYear ? "#fca5a5" : `${uniTalentColors.lightGray}80`,
                    color: form.startYear ? uniTalentColors.text : uniTalentColors.secondary,
                  }}
                >
            ...
            {errors.startYear && (
              <p className="text-xs mt-1.5" style={{ color: "#dc2626" }}>{errors.startYear}</p>
            )}
          </div>
          ...
          <div
            ...
            onClick={() =>
              setForm((prev) => ({
                ...
                ...(!prev.currentlyWorking ? { endMonth: undefined, endYear: undefined } : {}),
              }))
            }
          >
            <div>
              <p className="text-sm font-semibold" style={{ color: uniTalentColors.text }}>
            ...
            <div
              ...
              style={{
                backgroundColor: form.currentlyWorking ? uniTalentColors.primary : `${uniTalentColors.primary}80`,
              }}
            >
              <div
                className="absolute top-1 w-4 h-4 rounded-full bg-white shadow-sm transition-all duration-300"
                style={{ left: form.currentlyWorking ? "calc(100% - 20px)" : "4px" }}
              />
            </div>
          </div>
          ...
          {!form.currentlyWorking && (
            <div>
              <label className={labelClass} style={{ color: uniTalentColors.text }}>
                <span className="flex items-center gap-2">
                  <Calendar size={14} style={{ color: uniTalentColors.primary }} />
                  End Date <span style={{ color: uniTalentColors.primary }}>*</span>
                </span>
              </label>
              <div className="grid grid-cols-2 gap-3">
                <div className="relative">
                  <select
                    ...
                    style={{
                      borderColor: `${uniTalentColors.lightGray}80`,
                      color: form.endMonth ? uniTalentColors.text : uniTalentColors.secondary,
                    }}
                  >
                    <option value="">Month</option>
                    {MONTHS.map((m) => (
                ...
                <div className="relative">
                  <select
                    ...
                    className={inputClass + " appearance-none pr-8 cursor-pointer"}
                    style={{
                      borderColor: errors.endYear ? "#fca5a5" : `${uniTalentColors.lightGray}80`,
                      color: form.endYear ? uniTalentColors.text : uniTalentColors.secondary,
                    }}
                  >
                    <option value="">Year</option>
                    {YEARS.map((y) => (
              ...
              {errors.endYear && (
                <p className="text-xs mt-1.5" style={{ color: "#dc2626" }}>{errors.endYear}</p>
              )}
            </div>
          )}
