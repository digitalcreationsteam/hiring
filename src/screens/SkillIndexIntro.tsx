...
const SkillIndexIllustration = () => (
  ...
  >
    ...
    <g filter="url(#skillShadow)">
      ...
      <path
        d="M212 150 L252 130 L292 120 L332 130 L372 150"
        stroke="#FFFFFF"
        strokeWidth="3"
        fill="none"
        opacity="0.8"
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div className="flex flex-1 gap-2">
                      <div className="flex items-center gap-2 w-full">
                        <div className="h-1.5 flex-1 rounded-full bg-gradient-to-r from-gray-600 to-gray-800" />
                        {[1, 2, 3, 4].map((step) => (
                          <div
                            key={step}
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <p className="text-xs text-gray-500">
                          ...
                          designed to objectively evaluate your readiness for
                          this role.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <p className="text-xs text-gray-500">
                          ...
                          discover, evaluate, and rank your profile on
                          UniTalent.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-xs leading-relaxed text-gray-600">
                            ...
                            <br /> Recruiters rely on the Skill Index to make
                            decisions.
                            <br /> Your performance here determines how you
                            stand among others competing for the same roles.
                          </p>
                        </div>
                      </div>
                    </div>
